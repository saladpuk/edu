...
## 🎮ท้าทายฟามรู้
<Quiz title="จะให้คอมจำว่ามีเงิน 100 บาท เราจะเขียนโค้ดไงดี?" choices={frontMatter.choices} remarks={frontMatter.remarks} correctAnswer={frontMatter.correctAnswers} />